...
This guide explains how to set up the GitHub Actions workflows for automated deployment of the digitalvista  Innovations application.
...
```bash
# Staging
docker logs -f digitalvista-staging

# Production
docker logs -f digitalvista-production
```
...
- Docker image tag: `slemfowel1/digitalvista-digital-innovations:staging`
- Container name: `digitalvista-staging`
- Port: `4019`
...
- Container name: `digitalvista-production`
- Port: `4019`
...
```bash
docker logs digitalvista-staging
```
...
docker exec digitalvista-production npm run migrate
```
...
- name: Run Database Migrations
  run: docker exec digitalvista-production npm run db:migrate
```
...
```bash
# On server
docker stop digitalvista-production
docker rm digitalvista-production
docker pull slemfowel1/digitalvista-digital-innovations:previous_tag
docker run -d -p 4019:4019 --name digitalvista-production \
  --env-file /home/apps/.env.production \
  slemfowel1/digitalvista-digital-innovations:previous_tag
```
