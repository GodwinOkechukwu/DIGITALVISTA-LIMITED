  ...
  return (
    <>
      <header style={{
          ...
          }} className="flex flex-col w-full bg-[#131314CC] opacity-80 z-[100] fixed top-0 border-b border-[#5F3E3E33] shadow-2xl transition-all">
        {/* Desktop Header */}
        <div
          ...
          <div className="col-span-1 flex items-center justify-end gap-6">
            ...
            {email ? (
              ...
              <div className="relative inline-block text-left">
                <CircleUser className="text-white" fill="black" />
              </div>
            )}
          </div>
        </div>
