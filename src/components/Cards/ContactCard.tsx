...
const ContactCard = ({
  ...
  return (
    <div className="group relative flex flex-col items-center text-center bg-white border border-black/[0.07] rounded-2xl p-7 gap-4 overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.06),0_4px_16px_rgba(0,0,0,0.04)] transition-all duration-300 ease-[cubic-bezier(.22,.68,0,1.2)] hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(0,0,0,0.10),0_2px_8px_rgba(0,0,0,0.06)] hover:border-black/[0.12]">
      ...
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-[#B040C7] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded-t-2xl" />

      {/* Icon */}
      <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-[#B040C7]/10 text-[#B040C7] transition-all duration-300 group-hover:bg-[#B040C7] group-hover:text-white group-hover:scale-110 group-hover:rotate-3 shadow-[0_2px_8px_rgba(37,99,235,0.12)]">
        <span className="text-xl [&>svg]:w-5 [&>svg]:h-5">{icon}</span>
      </div>

      {/* Title */}
      <h3 className="text-sm font-semibold tracking-tight text-[#B040C7] leading-none">
        {title}
      </h3>
