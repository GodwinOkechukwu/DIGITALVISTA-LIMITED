  ...
  return (
    <div className="relative bg-[#fff] min-h-screen text-[#000] overflow-x-hidden w-[100%]">
      ...
      <section className="relative z-[1] px-6 pt-40 pb-[20px] text-center overflow-hidden">
        ...
        {/* Eyebrow pill */}
        <div className="relative z-[2] inline-flex items-center gap-2 mb-7 px-4 py-1.5 rounded-full border border-[rgba(201,169,110,0.2)] bg-[#B040C7]/10 text-[11px] font-semibold tracking-[0.2em] uppercase text-[#c9a96e]">
          <span className="w-1.5 h-1.5 rounded-full bg-[#B040C7] animate-blink" />
          Curated Collection
        </div>
        ...
        <h1 className="relative z-[2] font-serif text-[clamp(42px,7vw,88px)] font-semibold leading-[1.0] tracking-[-0.02em] mb-5">
          ...
          <br />
          <span
            className="not-italic text-[#B040C7]"
            // style={{
      ...
      <div className="relative z-[1] max-w-[1200px] mx-auto mb-8 px-4 sm:px-6 flex flex-wrap justify-center gap-3">
        {TRUST_ITEMS.map((t) => (
          <div
            key={t.label}
            className="flex items-center gap-2 px-[18px] py-2 rounded-full border border-white/[0.07] bg-white/[0.025] text-[13px] text-[#888480] transition-all duration-300 hover:text-[#B040C7] hover:border-[rgba(201,169,110,0.2)] cursor-default"
          >
            <span className="text-[#B040C7] text-[15px]">{t.icon}</span>
            {t.label}
          </div>
        ))}
      </div>
      ...
      >
        ...
        <p className="relative z-[1] text-[11px] font-semibold tracking-[0.2em] uppercase text-[#B040C7] mb-4">
          New Arrivals
        </p>
        ...
        <Link
          href="/new-arrivals"
          className="relative z-[1] inline-flex items-center gap-2 no-underline bg-[#B040C7] text-[#0a0a0b] font-semibold text-[14px] tracking-[0.04em] uppercase px-8 py-3.5 rounded-full transition-all duration-300 hover:bg-[#e8c98a] hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(201,169,110,0.4)]"
        >
          Shop New Arrivals
          <ArrowIcon />
        </Link>
